...
public class GcloudStorageCommands {
    public void createStorageBucket(String bucketName) throws Exception {
        CommandExecutor.runCommand("gcloud", "storage", "buckets", "create", "gs://" + bucketName);
    }

    public CmdResult removeStorageBucket(String bucketName) throws Exception {
        return CommandExecutor.runCommand("gcloud", "storage", "buckets", "delete", "gs://" + bucketName);
    }

    public void uploadFile(String bucketName, String fileName) throws Exception {
